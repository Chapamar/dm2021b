...
switch ( Sys.info()[['sysname']],
         Windows = { directory.root  <-  "C:/Users/Martin/Desktop/Carrera esp Datos_ITBA/Data Mining_E&F" },   #Windows
...
campos_malos  <- c( "mpasivos_margen", "mactivos_margen", "cplazo_fijo", "mpayroll" )   #aqui se deben cargar todos los campos culpables del Data Drifting
